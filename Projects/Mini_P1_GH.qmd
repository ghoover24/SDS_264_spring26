---
title: "Analysis of Headlines Relating to Women"
format: pdf
editor_options: 
...
```{r, echo = FALSE}
headlines |>
  mutate(length = str_length(headline_no_site))|>
...
str_subset(headlines$headline_no_site, "sister")
```
...
```{r, eval = FALSE, include = FALSE}
str_subset(headlines$headline_no_site, "beaut")
```
