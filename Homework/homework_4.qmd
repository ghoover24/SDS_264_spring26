...
rice_county |>
  ...
  ggplot(aes(x = year, y = median_income, color = year)) +
  geom_boxplot() +
  geom_jitter() +
  labs(x = "Year",
       y = "Median Income",
       color = "Year",
       title = "Median Income in Rice County over Time")
```
...
rice_county |>
  mutate(year = as.factor(year)) |>
  ggplot(aes(x = year, y = population, color = year)) +
  geom_boxplot() +
  geom_jitter() +
  labs(x = "Year",
       y = "Population",
       color = "Year",
       title = "Population of Rice County over Time")
```
