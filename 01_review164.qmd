...
vaccine_data |>
  ...
  mutate(region_sort = fct_relevel(region, "Northeast", 
                                  "West",
                                  "Midwest",
                                  "South")) |>
...
```{r}
ggplot(vaccine_data, aes(x = as.factor(rural_urban_code), y = perc_complete_vac)) +
  geom_boxplot() # boxplot

ggplot(vaccine_data, aes(x = as.factor(rural_urban_code), y = perc_complete_vac)) +
  geom_jitter(alpha = 0.5)  # jitter

# ggplot(vaccine_data, aes(x = rural_urban_code, y = perc_complete_vac)) +
```
