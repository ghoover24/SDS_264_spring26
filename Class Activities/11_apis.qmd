...
omdb_api_key <- readLines("~/SDS 264 Spring 2026/SDS_264_spring26/omdb_api_key")
```
...
```{r}
omdb_api_key <- readLines("~/SDS 264 Spring 2026/SDS_264_spring26/omdb_api_key.txt")
print(omdb_api_key)
...
for(i in 1:5) {
  ...
  omdb[i,2] <- **FILL IN**  # rating --> where does it live?
...
## National Park data on your own
...
# Load in your API key
census_api_key <- readLines("~/SDS 264 Spring 2026/SDS_264_spring26/Class Activities/us_census_api_key")
