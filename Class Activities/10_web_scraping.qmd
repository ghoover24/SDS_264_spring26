...
```{r}
nih_description <- html_nodes(nih, ".thumbnail-teaser__description") |>
  html_text()
```
...
scrape_page <- function(url) {
  ...
  page <- scrape(session)
  nih_title <- get_text_from_page(".thumbnail-teaser__title")
  nih_description <- get_text_from_page(".thumbnail-teaser__description")
